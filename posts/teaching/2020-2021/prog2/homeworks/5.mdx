...
ALE POZOR — ne na _ledajaké_ takové místo, ale na místo, kde je **pouze jedna** možnost, jaké číslo tam podle pravidel výše doplnit. Ve výstupu napište `Inserted <NUM> at position <X>, <Y>, the new table is <NEW TABLE>`.

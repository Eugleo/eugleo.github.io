export const metadata = {
  title: 'Proměnné',
  description: 'Procvičování tvorby a pojmenovávání proměnných',
...
3. (2 body) Ve většině jazyků se ve jménech proměnných nesmí vyskytovat mezery, liší se ale způsoby, jakým se v nich značí jednotlivá slova. Nejčastější způsoby oddělení slov jsou:

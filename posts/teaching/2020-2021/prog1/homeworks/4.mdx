...
Všechny úlohy řešte napsáním pouze jedné funkce (není-li řečeno jinak), a to způsobem, jaký jsme si ukazovali na poslední přednášce — tj. funkce volá samu sebe. Pokud není řečeno jinak, nepoužívejte jiné funkce než ty, které jsme používali v hodině.

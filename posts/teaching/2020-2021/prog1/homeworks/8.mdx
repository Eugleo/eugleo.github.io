...
7. Kolik různých hodnot je v typu `Boolean`? Tj. kdybychom měli nějakou proměnnou `x :: Boolean = ...`, kolik různých věcí bychom mohli doplnit místo `...`, aby ten kód byl platný?

8. Kolik různých hodnot je (teoreticky) v typu `Number`?

9. Kolik různých hodnot je v typu `OrganismState`, který je definovaný níže?
...
10. Kolik různých hodnot je v typu `EscherichiaColi`, který je definovaný níže?

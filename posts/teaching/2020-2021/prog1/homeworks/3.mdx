export const metadata = {
  ...
  description: 'Funkce — tvoření vlastních funkcí a jejich používání k řešení úloh',
...
Budete-li mít jakékoli dotazy, ptejte se. Za otázky body nestrhávám :-) Můžete se zeptat svých kolegů, jen vás poprosím, abyste si neposílali přímo kód úkolu; diskuze na abstraktní myšlenkové úrovni jsou v pořádku.

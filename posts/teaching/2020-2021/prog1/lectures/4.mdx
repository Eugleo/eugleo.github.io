export const metadata = {
  ...
  description:
    'Naučili jsme se pomocí if/else v rámci algoritmů rozhodovat, co uděláme, na základě hodnoty nějaké proměnné. Objevili jsme datový typ "boolean", který vyjadřuje pravdu a nepravdu. A neposlední řadě jsme si ukázali, že funkce mohou volat sami sebe a naučili jsme se pomocí toho řešit nové sloužité problémy.',
